...
find-<-Min⁺ l r loc w i j (⊨inl .l .r .loc .i .j .w lij⊨w) =  ⊨inl l r loc i j w lij⊨w , <-min⁺ l r loc w i j (⊨inl l r loc i j w lij⊨w) {!!}
...
data _,_,_,_,_,_,_⊢⁺_<_ where
  ...
  inlinl : ∀ { l r : RE } { loc : ℕ } { w : List Char }
    → ( i j j' : ℕ )
    → ( t₁ : l , i , j  ⊨ w ) -- the evidence of ⊨inl l r loc i j w ∈ Tᵢ 
    → ( t₂ : l , i , j' ⊨ w ) -- the evidence of ⊨inr l r loc i j' w ∈ Tᵢ
    → l , w , i ⊢ j < j'
    -----------------------------------------------------------------------
  ...
  inrinr : ∀ { l r : RE } { loc : ℕ } { w : List Char }
    → ( i j j' : ℕ )
    → ( t₁ : r , i , j  ⊨ w ) -- the evidence of ⊨inl l r loc i j w ∈ Tᵢ 
    → ( t₂ : r , i , j' ⊨ w ) -- the evidence of ⊨inr l r loc i j' w ∈ Tᵢ
    → l , w , i ⊢ j < j'
    -----------------------------------------------------------------------
