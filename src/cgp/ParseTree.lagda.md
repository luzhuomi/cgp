...
...                                                | xs , xs∈l | ys , ys∈r = xs ++ ys , _●_⧺_ xs∈l ys∈r refl
...
...                                   | x , x∈r  | xs , xs∈r* = ( x ++ xs ) , ((ε +R (_●_⧺_ x∈r xs∈r* refl)) *) 
```
...
unflat {l ● r ` loc } {xs++ys} (_●_⧺_ xs∈l ys∈r eq )                 = PairU (unflat xs∈l ) ( unflat ys∈r )
unflat {r * nε ` loc } (( (r ● (r * nε ` loc ) ` loc ) +L ε ) *)     = ListU []
unflat {r * nε ` loc } (( ε +R (_●_⧺_ x∈r xs∈r* eq ) ) *)            =
...
unflat_a* : U  (($ 'a' ` 1 ) * ε∉$ ` 2)
unflat_a* = unflat (( ε +R ( _●_⧺_ a∈$a ( ( ( a ● (a * ε∉$ ` 2) ` 2 ) +L ε ) * ) refl ))  * )
  where
    a∈$a : [ 'a' ] ∈⟦ $ 'a' ` 1  ⟧ 
    a∈$a = $ 'a'
    a : RE
...
flat∘unflat {l ● r ` loc } {xs++ys} (_●_⧺_ xs∈l ys∈r eq) rewrite flat∘unflat xs∈l | flat∘unflat ys∈r with eq
...
flat∘unflat {r * nε ` loc }   {x++xs}  ((ε +R (_●_⧺_ x∈r xs∈r* eq)) *) rewrite flat∘unflat x∈r | listU∘unListU {r} {nε} {loc} {unflat xs∈r*} | flat∘unflat xs∈r* with eq
...                                                                                                                                                                  | refl = refl  -- short version
-- detailed version
{- 
