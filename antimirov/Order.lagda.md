...
Ordering among monomial tail parse trees
  ...
  where
    ...
    >-inc-ev (PairU (PairU v₁ v₂) v₃) (PairU (PairU v₄ v₅) v₆) (seq₁oneempty ¬proj₁flat-v₁++proj₁flat-v₂≡[] proj₁flat-v₄++proj₁flat-v₅≡[]) =
      ...
      Goal: (l ● r ` loc) ⊢ injFst (PairU (PairU v₁ v₂) v₃) > injFst (PairU (PairU v₄ v₅) v₆)
        ...
        we need to show (PairU v₁ v₂) > (PairU v₄ v₅) in order to use  u₁→u₂→u₁>u₂→inj-u₁>inj-u₂
          where u₁ = (PairU v₁ v₂) and u₂ = (PairU v₄ v₅)
            ...
            given  ¬proj₁flat-v₁++proj₁flat-v₂≡[], and proj₁flat-v₄++proj₁flat-v₅≡[],
              ...
              sub case 1 v₁≡v₄ ,  then v₂ is not empty,  v₅ is empty. For seq₂ to hold as the evidence,  we need to show q ⊢ v₂ > v₅ .
                         but how? does |v₂| > |v₅| imply v₂ > v₅? what if R [a] and L []?  not possible, because L [] will be in another pdi! but how? to tell? monommial ordering? 
    ...
    >-inc-ev (PairU (PairU v₁ v₂) v₃) (PairU (PairU v₄ v₅) v₆) (seq₁notempty ¬proj₁flat-v₁++proj₁flat-v₂≡[] ¬proj₁flat-v₄++proj₁flat-v₅≡[] pair-v₁-v₂>pair-v₄-v₅) = {!!}     
