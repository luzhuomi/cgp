      ...
      where    
        ...
        first = 
          ...
          where
            ...
            sub ( (e , flat-[]-e) ∷ es-flat-[]-es ) (q ∷ qs ) (>-inc-q ∷ >-inc-qs ) = >-inc-map-fuse-pdi-fst  {l+s} {r} {ε∈l+s} {loc} {c}  pˡ (List.concatMap (λ x → List.map (mk-snd-pdi x) (q ∷ qs)) ((e , flat-[]-e) ∷ es-flat-[]-es))  >-inc-pˡ >-inc-concatmap-map-mk-snd-pdi-qs-es-flat-[]-es   
              where
