An class of RE "in-between" LNN and RLN, i.e. LNN < RLNN < RLN in terms of the set of possibel RE. RLNN is sufficient to imply greedy lne iso but not sufficient. 
```agda

{-# OPTIONS --rewriting  #-}
module cgp.robust.greedylne.RLNN where
...
Definition: RLNN - relaxed LNN, intermediate between RLN and LNN
